...
contract AuctionTest is Auction{
    ...
    function checkBid() public payable{
        ...
        Assert.equal(highestBidder, acc1, "Invalid highest bidder");
    }
    ...
    function checkSecondBid() public payable{
        // Second bid -> 3 ether
        bid();
        Assert.equal(msg.sender, acc2, "Invalid sender");
        ...
        // Check new highestBidder
        address highestBidder = getHighestBidder();
        Assert.equal(highestBidder, acc2, "Invalid highest bidder");
    }
